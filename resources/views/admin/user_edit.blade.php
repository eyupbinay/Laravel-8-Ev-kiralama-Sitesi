                        ...
                        <div style="width:1000px; height: auto;">
                            <form action="{{route('admin_user_update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                                ...
                                <table>
                                    ...
                                    <tr><h4>Name:</h4><input style="width: 1000px" id="name" value="{{$data->name}}" type="text" name="name" placeholder="Name"/></tr>
                                    <tr><h4>Email:</h4> <input style="width: 1000px" id="email" value="{{$data->email}}" type="text" name="email" placeholder="Email"/></tr>
                                    <tr><h4>Phone: </h4><input style="width: 1000px" id="phone" value="{{$data->phone}}" type="text" name="phone" placeholder="Phone"/></tr>
