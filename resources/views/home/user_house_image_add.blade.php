        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">Mekan: {{$data->title}}</h5>
                    <p class="place">Resim Ekleme Sayfasındasınız</p>
                </div>
                <div class="card-body">

                    <div style="width:1000px; height: auto;">
                        <form action="{{route('user_image_store',['house_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <table>
                        ...
                        <table class="table" style="width: 1000px">
                            ...
                            @foreach($images as $rs)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('user_image_delete',['id'=>$rs->id,'house_id'=>$data->id])}}" onclick="return confirm('Delete ! Are you sure?')"><img src="{{asset('assets/admin/images')}}/delete.png" height="30"></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
